...
if [ -f ${HOME}/.bash_profile ]; then
  ...
  echo "export OPENAI_MODEL=gpt-3.5-turbo OPENAI_TEMPERATURE=0.7 OPENAI_MAX_TOKENS=4000 OPENAI_TOP_P=1 OPENAI_FREQUENCY_PENALTY=0.1 OPENAI_PRESENCE_PENALTY=0.1" >> ~/.aai
